...
public class RectView extends View {
    ...
    public RectView(Context context) {
        super(context);
        Log.d(TAG,"RectView(Context context)");
        initDraw();
    }

    public RectView(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.d(TAG,"RectView(Context context, AttributeSet attrs)");
    ...
    public RectView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Log.d(TAG,"RectView(Context context, AttributeSet attrs, int defStyleAttr)");
        initDraw();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //参考：android.view.ViewGroup.getChildMeasureSpec来选择模式
        //android.view.View.onMeasure
        //android.view.View.getDefaultSize
