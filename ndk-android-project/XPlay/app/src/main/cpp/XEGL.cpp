...
public:
    ...
    virtual void Close()
    {
        ...
        eglMakeCurrent(display,EGL_NO_SURFACE,EGL_NO_SURFACE,EGL_NO_CONTEXT);//先调用该函数解除绑定，以便于下面销毁和终止函数，能够完全立即释放资源
    ...
    virtual bool Init(void *win)
    {
        ...
        {
            mux.unlock();
            XLOGE("eglCreateContext failed! error:%d",eglGetError());
            return false;
        }
