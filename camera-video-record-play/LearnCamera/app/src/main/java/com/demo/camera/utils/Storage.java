...
import com.demo.camera.IbotnCamera2App;
...
public class Storage {
    ...
    /**
     * 1. 【拍照】【录像】对应的文件存储根路径  /storage/sdcard/DCIM <br/>
    ...
    private static void initDCIM() {
        if(DevicePath.getInstance(IbotnCamera2App.getInstance()).isExistUsbStoragePath(IbotnCamera2App.getInstance()))
            DCIM = DevicePath.getInstance(IbotnCamera2App.getInstance()).getUsbStoragePath(IbotnCamera2App.getInstance()) + File.separator + Environment.DIRECTORY_DCIM;
        else if(DevicePath.getInstance(IbotnCamera2App.getInstance()).isExistSDExtStoragePath(IbotnCamera2App.getInstance()))
            DCIM = DevicePath.getInstance(IbotnCamera2App.getInstance()).getSDExtStoragePath(IbotnCamera2App.getInstance())+ File.separator + Environment.DIRECTORY_DCIM;
        else
    ...
    /**
     * 【拍照】【录像】对应的文件存储根路径 /storage/sdcard/DCIM/Camera/
     */
    ...
    public static final long NEW_DIRECTORY_FAILED = -4L;
    public static final long LOW_STORAGE_THRESHOLD_BYTES = 200 * 1000 * 1000;
    ...
    public static Uri addImage(ContentResolver resolver, String title, long date,
                               Location location, int orientation, byte[] jpeg, int width,
                               int height) {

        return addImage(resolver, title, date, location, orientation, jpeg, width, height,
                MIME_TYPE_JPEG);
    }
