...
public class LcbAliveService extends Service {
	...
	private final String A_PackageName = "com.demo.keepaliveonemultiprocess";
	private final String A_ServicePath = "com.demo.keepaliveonemultiprocess.AssistantAService";
	private final String A_ServiceAction = "action.com.demo.keepaliveonemultiprocess.AssistantAService";
...
//		serverIntent.setAction(A_ServiceAction);//use action
